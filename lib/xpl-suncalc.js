...
var proto = {
	...
	_log: function(log) {
		...
		self.configHash.version = self.version;
                ...
                self.configHash.latitude = evt.body.latitude;
                self.configHash.longitude = evt.body.longitude;
			...
			else self._sendXplStat(self.configHash, 'suncalc.config', evt.header.source);
                });
        },
